...
<div class="">
  ...
  <div class=" content">
    ...
    <div class=" header">
      ...
      <h4 class="title title_add">Thêm Sinh Viên</h4>
    </div>
    <div class=" body">
...
<form name='add_master_category' action='<?php echo admin_url();?>Student_Manager/do_add_student' id="add_form" method='POST'  enctype="multipart/form-data" >   
  <span id="error">   </span>



  <div class="form-group">
    <label for="name"></span>MSSV</label> 

    <input type="text" class="form-control" id="add_title"  name="code"  value="<?php echo set_value('name'); ?>"  placeholder="Enter Job Name">            
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="add_title"  name="name"  value="<?php echo set_value('name'); ?>"  placeholder="Enter Job Name">            
    <div class="form-error"> <?php echo form_error('name')?> </div> 
  </div>
    ...
    <select name ="course">
        <option value="39">Khóa 39</option>
        <option value="40">Khóa 40</option>
        <option value="41">Khóa 41</option>
        <option value="42">Khóa 42</option>
    </select>
   ...
   <div class="form-group">
    ...
    <div style ="margin-bottom: 10px;">
     ...
     <div class="fb-button">
                     <input name="attach_position_description" id="item8_file_1" type="file" data-hint="" >
                  </div>
