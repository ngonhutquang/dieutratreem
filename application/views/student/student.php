...
<div class="">
 ...
 <?php  echo $this->uri->segment(1) ?>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <?php if ($dissertation->status == 1) { ?>
                     <div> <span id="view_name_url"><a href="">Tai luan van</a> </span> </div>
                  <?php 
                
                   pre ($dissertation_detail);} ?>
             ...
             <!--   <div class="form-group">
               ...
               <div class="form-group">
                  <label for="code"></span>Date time</label>
                  <div> <span id="view_date"> NGuyễn Văn A</span> </div>       
               </div>
