 ...
 //Delete Teacher   
  ...
  $('#job_table tbody').on( 'click', '.delete_teacher', function (e) {       
    ...
    // job status manager view 
        ...
        //            var  content = {title:title,student_code:student_code,teacher_code:teacher_code}
        ...
        // });
          ...
          $("#addDissertation").click(function(){
                ...
                // alert("Student : " + student_result + "Teacher: " + teacher_result);
                   ...
                   var  content = {dissertation_code:dissertation_code,title:title,type:type,student_code:student_code,teacher_code:teacher_code}
         ...
         $("#btnSave_Dissertation").click(function(){
                ...
                // alert("Student : " + student_result + "Teacher: " + teacher_result);
                   ...
                   var  content = {id:dissertation_id,code:dissertation_code,title:title,type:type,student_code:student_code,teacher_code:teacher_code}
